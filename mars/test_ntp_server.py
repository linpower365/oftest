...
class NTPServerTest(base_tests.SimpleDataPlane):
    ...
    def runTest(self):
        ...
        response = requests.get(
            URL+'ntpserver/v1', cookies=COOKIES, headers=GET_HEADER)
        ...
        response = requests.get(URL+'ntpserver/v1/' +
                                device_id, cookies=COOKIES, headers=GET_HEADER)
        ...
        response = requests.put(
            URL+'ntpserver/v1', json=payload, cookies=COOKIES, headers=POST_HEADER)
