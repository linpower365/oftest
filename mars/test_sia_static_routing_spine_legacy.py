...
class UntagHostWithDifferentSubnetInDifferentLeaf(SIAStaticRouting):
    ...
    def runTest(self):
        ...
        sr1 = (
            StaticRouting()
            .add_rest_switch_vlan(cfg.sw67_205['id'], 2, "192.168.2.254/24", [])
            .add_rest_switch_vlan(cfg.sw67_205['id'], 10, "192.168.0.254/24", [])
...
class UntagHostWithDifferentSubnetInSameLeaf(SIAStaticRouting):
    ...
    def runTest(self):
        ...
        sr1 = (
            StaticRouting()
            .add_rest_switch_vlan(cfg.sw67_205['id'], host1_vlan, "192.168.8.254/24", [])
            .add_rest_switch_vlan(cfg.sw67_205['id'], host2_vlan, "192.168.20.254/24", [])
            .add_host_vlan(host_vlan_cfg1)
            .add_host_vlan(host_vlan_cfg2)
            .build()
        )
        ...
        sr2 = (
            StaticRouting()
            .add_rest_switch_vlan(cfg.sw67_205['id'], 18, "192.168.18.254/24", [])
            .add_host_vlan(host_vlan_cfg1)
            .build()
        )
...
class UntagHostWithSameSubnetInSameLeaf(SIAStaticRouting):
    ...
    def runTest(self):
        ...
        sr1 = (
            StaticRouting()
            .add_rest_switch_vlan(cfg.sw67_205['id'], 10, "192.168.10.254/24", [])
            .add_host_vlan(host_vlan_cfg1)
            .add_host_vlan(host_vlan_cfg2)
            .build()
        )
...
class TagHostWithSameSubnetInDifferentLeaf(SIAStaticRouting):
    ...
    def runTest(self):
        ...
        sr1 = (
            StaticRouting()
            .add_rest_switch_vlan(cfg.sw67_205['id'], 100, "192.168.0.254/24", [])
            .add_host_vlan(host_vlan_cfg1)
            .add_host_vlan(host_vlan_cfg2)
            .build()
        )
...
class TagHostWithSameSubnetInSameLeaf(SIAStaticRouting):
    ...
    def runTest(self):
        ...
        sr1 = (
            StaticRouting()
            .add_rest_switch_vlan(cfg.sw67_205['id'], 200, "192.168.200.254/24", [])
            .add_host_vlan(host_vlan_cfg1)
            .build()
        )
...
class UntagClientToServerWithSameSubnet(SIAStaticRouting):
    ...
    def runTest(self):
        ...
        sr1 = (
            StaticRouting()
            .add_rest_switch_vlan(cfg.sw67_205['id'], 50, "192.168.50.254/24", [])
            .add_host_vlan(host_vlan_cfg1)
            .add_host_vlan(host_vlan_cfg2)
            .build()
        )
...
class UntagClientToServerWithDifferentSubnet(SIAStaticRouting):
    ...
    def runTest(self):
        ...
        sr1 = (
            StaticRouting()
            .add_rest_switch_vlan(cfg.sw67_205['id'], 5, "192.168.5.254/24", [])
            .add_rest_switch_vlan(cfg.sw67_205['id'], 253, "192.168.253.254/24", [])
            .add_host_vlan(host_vlan_cfg1)
            .add_host_vlan(host_vlan_cfg2)
            .build()
        )
...
class TagClientToServerWithSameSubnet(SIAStaticRouting):
    ...
    def runTest(self):
        ...
        sr1 = (
            StaticRouting()
            .add_rest_switch_vlan(cfg.sw67_205['id'], 60, "192.168.60.254/24", [])
            .add_host_vlan(host_vlan_cfg1)
            .add_host_vlan(host_vlan_cfg2)
            .build()
        )
...
class UntagHostWithSameSubnetInSameLeafFor30T(SIAStaticRouting):
    ...
    def runTest(self):
        ...
        sr1 = (
            StaticRouting()
            .add_rest_switch_vlan(cfg.sw67_205['id'], 55, "192.168.0.254/24", [])
            .add_host_vlan(host_vlan_cfg1)
            .build()
        )
...
class UntagHostWithSameSubnetInDifferentLeafFor30T(SIAStaticRouting):
    ...
    def runTest(self):
        ...
        sr1 = (
            StaticRouting()
            .add_rest_switch_vlan(cfg.sw67_205['id'], vlan_id, "192.168.0.254/24", [])
            .add_host_vlan(host_vlan_cfg1)
            .add_host_vlan(host_vlan_cfg2)
...
class UntagHostWithLegacySwitchInTagLeafPort_SameSubnet(SIAStaticRouting):
    ...
    def runTest(self):
        ...
        sr1 = (
            StaticRouting()
            .add_rest_switch_vlan(cfg.sw67_205['id'], 60, "192.168.60.254/24", [])
            .add_rest_switch_vlan(cfg.sw67_205['id'], 70, "192.168.70.254/24", [])
            .add_host_vlan(host_vlan_cfg1)
            .add_host_vlan(host_vlan_cfg2)
            .build()
        )
...
class UntagHostWithLegacySwitchInTagLeafPort_SameSubnet2(SIAStaticRouting):
    """
    Test untag host with legacy switch in tag leaf port
    """
...
class UntagHostWithLegacySwitchInTagLeafPort_DifferentSubnet(SIAStaticRouting):
    ...
    def runTest(self):
        ...
        sr1 = (
            ...
            .add_rest_switch_vlan(cfg.sw67_205['id'], 60, "192.168.60.254/24", [])
            .add_rest_switch_vlan(cfg.sw67_205['id'], 70, "192.168.70.254/24", [])
            .add_rest_switch_vlan(cfg.sw67_205['id'], 90, "192.168.90.254/24", [])
            .add_host_vlan(host_vlan_cfg1)
            .add_host_vlan(host_vlan_cfg2)
            .add_host_vlan(host_vlan_cfg3)
            .build()
...
class UntagHostWithSameVlanDifferentSubnetInSameLeaf(SIAStaticRouting):
    """
    Test untag hosts are in same vlan with different subnet in same leaf
    """
    ...
    def runTest(self):
        ...
        host_vlan_cfg1 = {
            ...
            'vlanId': 50,
            'tagPorts': [],
            'untagPorts': [cfg.sw46_185['front_port_A'], cfg.sw46_185['front_port_B']]
        }

        sr1 = (
            StaticRouting()
            .add_rest_switch_vlan(cfg.sw67_205['id'], 50, "192.168.60.254/24", ["192.168.70.254/24"])
            .add_host_vlan(host_vlan_cfg1)
            .build()
        )
...
class UntagHostWithSameVlanDifferentSubnetInDifferentLeaf(SIAStaticRouting):
    """
    Test untag hosts are in same vlan with different subnet in different leaf
    """
    ...
    def runTest(self):
        ...
        sr1 = (
            StaticRouting()
            .add_rest_switch_vlan(cfg.sw67_205['id'], 70, "192.168.80.254/24", ["192.168.90.254/24"])
            .add_host_vlan(host_vlan_cfg1)
            .add_host_vlan(host_vlan_cfg2)
            .build()
        )
        ...
        assert('success' == h0.ping(host1['ip']))
        assert('success' == h1.ping(host0['ip']))


class UntagHostWithSameVlanDifferentSubnetInLegacySwitch(SIAStaticRouting):
    """
    Test untag hosts are in same vlan with different subnet in legacy switch
    """
...
class UntagHostWithSameVlanDifferentSubnet_MultipleSubnet(SIAStaticRouting):
    """
    Test untag hosts are in same vlan with multiple different subnet
    """
...
class A_PrepareLegacySwitch(SIAStaticRouting):
    """
    Configure legacy switch for test
    """

    def runTest(self):
        legacy_switch_create_vlan()
        legacy_switch_set_port1()
        legacy_switch_set_lldp_tx_interval()


class A_PrepareStaticHost(SIAStaticRouting):
    """
    Configure static host for test
    """
    ...
    def runTest(self):
        ...
        for i in range(20):
            cfg = {
                'mac': "46:E4:3C:11:33:{:02x}".format(i),
                'vlan': "-1",
                'ipAddresses': ["192.168.201.{}".format(i)],
                'locations': [{
                    "elementId": "of:000068215fcff728",
                    "port": "{}".format(i)
                }]
            }

            static_host = StaticHost(cfg).build()

        for i in range(20):
            cfg = {
                'mac': "46:E4:3C:11:55:{:02x}".format(i),
                'vlan': "-1",
                'ipAddresses': ["192.168.202.{}".format(i)],
                'locations': [{
                    "elementId": "of:0000b86a970c01c0",
                    "port": "{}".format(i)
                }]
            }
        ...
        for i in range(40):
            cfg = {
                'mac': "46:E4:3C:11:77:{:02x}".format(i),
                'vlan': "-1",
                'ipAddresses': ["192.168.203.{}".format(i)],
                'locations': [{
                    "elementId": "of:0000b86a97145100",
                    "port": "{}".format(i)
                }]
            }
